...
class MainActivity : ComponentActivity() {
        ...
        setContent {
            My_Theme {
                Scaffold (modifier = Modifier.fillMaxSize()
                    ...
                    FetchRewardsApp(innerPadding)
                }
            }
        }
    }

    fun callRewardsService(){
        viewModel.getRewards()
    }

    @Composable
    fun FetchRewardsApp(innerPadding: PaddingValues){
    ...
    fun PreviewFetchRewardsApp(){
        My_Theme {
            FetchRewardsApp(innerPadding = PaddingValues(15.dp))
        }
    }
}